...
export const Sidebar: React.FC = () => {
  ...
  const navItems: NavItem[] = [
    ...
    { id: "routes", label: "Route Optimizer", icon: Route, href: "/", badge: "3 Options" },
    { id: "history", label: "Tx History", icon: History, href: "/" },
    { id: "settings", label: "Preferences", icon: Settings, href: "/" },
  ];
    ...
    <aside className="w-64 h-[calc(100vh-65px)] sticky top-[65px] glass-panel border-r border-white/10 p-4 flex flex-col justify-between hidden md:flex">
      ...
      <div className="space-y-6">
        ...
        <nav className="space-y-1.5">
          {/* Phase 11 — Business Payment Operations Dashboard */}
          <Link
            href="/dashboard"
