...
/** The 13 stages of the end-to-end demo walkthrough. */
export const DEMO_STAGES = [
  ...
  { n: 4, key: "routes", title: "Candidate routes" },
  { n: 5, key: "scoring", title: "Mathematical route scoring" },
  { n: 6, key: "recommended", title: "Recommended route" },
  { n: 7, key: "risk", title: "Risk assessment" },
  { n: 8, key: "simulation", title: "Transaction simulation" },
  { n: 9, key: "explanation", title: "AI explanation" },
  { n: 10, key: "approval", title: "Human approval" },
  { n: 11, key: "execute", title: "SmartWallet execution" },
  { n: 12, key: "confirm", title: "Transaction confirmation" },
  { n: 13, key: "audit", title: "Audit history" },
] as const;
...
export interface DemoPipelineResult {
  ...
  plan: PaymentPlan;
  /** Route optimizer output (weighted scoring of all candidates). */
